...
def test_filter_new_repos_stores_only_unique_repo_names_for_each_keyword(storage: dict) -> None:
    # GIVEN
    events = [
        GithubEvent(keyword="keyword1", repo_fullname="repo1", found_date=datetime.now(), stars_cnt=1, langs=["Java"]),
        GithubEvent(keyword="keyword2", repo_fullname="repo2", found_date=datetime.now(), stars_cnt=1, langs=["Java"]),
        GithubEvent(keyword="keyword2", repo_fullname="repo2", found_date=datetime.now(), stars_cnt=1, langs=["Java"]),
        GithubEvent(keyword="keyword1", repo_fullname="repo3", found_date=datetime.now(), stars_cnt=1, langs=["Java"])
    ]
    expected_storage = {
